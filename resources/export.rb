...
property :directory, property: true
property :network, required: true
property :writeable, [TrueClass, FalseClass], default: false
property :sync, [TrueClass, FalseClass], default: true
property :options, Array, default: ['root_squash']
property :anonuser
property :anongroup
property :unique, [TrueClass, FalseClass], default: false
